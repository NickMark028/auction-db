...
/* USER + BIDDER */
/*********************************************************/
CALL RegisterBidder('hcleft0@spotify.com', 'hcleft0@spotify.com', 'Dove, galapagos', 'Hobart', 'Cleft', '86 Calypso Hill', '2012-02-22');
CALL RegisterBidder('apomroy1@washingtonpost.com', 'apomroy1@washingtonpost.com', 'Monitor lizard (unidentified)', 'Angie', 'Pomroy', '1266 Porter Trail', '2012-07-10');
CALL RegisterBidder('gherity2@gravatar.com', 'gherity2@gravatar.com', 'Dove, galapagos', 'Garland', 'Herity', '585 Oneill Hill', '2017-05-09');
CALL RegisterBidder('sdecruse3@unesco.org', 'sdecruse3@unesco.org', 'Salmon, sockeye', 'Shelby', 'Decruse', '1 Manufacturers Avenue', '2019-06-07');
CALL RegisterBidder('mrivalant4@google.es', 'mrivalant4@google.es', 'Drongo, fork-tailed', 'Merrie', 'Rivalant', '0069 Del Mar Hill', '2018-12-25');
CALL RegisterBidder('cbatalini9@bloglovin.com', 'cbatalini9@bloglovin.com', 'Opossum, american virginia', 'Clemmie', 'Batalini', '0 Pennsylvania Way', '2016-07-30');
CALL RegisterBidder('jdaina@virginia.edu', 'jdaina@virginia.edu', 'Water monitor', 'Jo-ann', 'Dain', '55811 Ryan Junction', '1999-06-27');
CALL RegisterBidder('amaccarlichb@theatlantic.com', 'amaccarlichb@theatlantic.com', 'Spotted-tailed quoll', 'Angelia', 'MacCarlich', '87854 Browning Circle', '2001-07-16');
CALL RegisterBidder('bdedneyc@joomla.org', 'bdedneyc@joomla.org', 'White-necked raven', 'Bertie', 'Dedney', '38619 Sunbrook Point', '1994-07-09');
CALL RegisterBidder('hmangiond@pen.io', 'hmangiond@pen.io', 'Defassa waterbuck', 'Hanan', 'Mangion', '380 Daystar Road', '2010-11-07');
CALL RegisterBidder('mwoodwinge@cbc.ca', 'mwoodwinge@cbc.ca', 'Toucan, white-throated', 'Maximilianus', 'Woodwing', '8543 Messerschmidt Park', '2004-03-21');
CALL RegisterBidder('cbhatiaf@blog.com', 'cbhatiaf@blog.com', 'Lemming, arctic', 'Christi', 'Bhatia', '80091 Stephen Junction', '1988-08-13');
CALL RegisterBidder('dhunnaballg@dion.ne', 'dhunnaballg@dion.ne', 'European wild cat', 'Davis', 'Hunnaball', '412 Sachs Avenue', '2010-02-20');
CALL RegisterBidder('ysparhamh@admin.ch', 'ysparhamh@admin.ch', 'Scottish highland cow', 'Yetta', 'Sparham', '6 Clove Alley', '1999-08-21');
CALL RegisterBidder('mreadmirei@ustream.tv', 'mreadmirei@ustream.tv', 'Bohor reedbuck', 'Mame', 'Readmire', '984 Hauk Pass', '1984-12-12');
CALL RegisterBidder('pgiacopelloj@census.gov', 'pgiacopelloj@census.gov', 'Western spotted skunk', 'Pavel', 'Giacopello', '6599 Warner Alley', '1988-01-06');
CALL RegisterBidder('ssoutherdenk@xrea.com', 'ssoutherdenk@xrea.com', 'Tyrant flycatcher', 'Sidoney', 'Southerden', '6 Kingsford Avenue', '1990-08-07');
CALL RegisterBidder('ngoodluckl@prnewswire.com', 'ngoodluckl@prnewswire.com', 'Flightless cormorant', 'Nady', 'Goodluck', '8 Cottonwood Alley', '1998-01-30');
CALL RegisterBidder('okembleym@facebook.com', 'okembleym@facebook.com', 'Common pheasant', 'Orren', 'Kembley', '83608 Heath Hill', '2011-03-27');
CALL RegisterBidder('coxtobyn@exblog.jp', 'coxtobyn@exblog.jp', 'Squirrel, pine', 'Cleopatra', 'Oxtoby', '19 Manley Avenue', '1996-06-14');
CALL RegisterBidder('eglasspoolo@mediafire.com', 'eglasspoolo@mediafire.com', 'Baleen whale', 'Elayne', 'Glasspool', '5 American Alley', '2019-11-04');
CALL RegisterBidder('coldfieldp@yolasite.com', 'coldfieldp@yolasite.com', 'Civet, common palm', 'Cristie', 'Oldfield', '45538 Lighthouse Bay Court', '2002-12-27');
CALL RegisterBidder('mfilyushkinq@amazon.co', 'mfilyushkinq@amazon.co', 'Heron, green-backed', 'Mala', 'Filyushkin', '79534 Sloan Crossing', '2003-07-12');
CALL RegisterBidder('dscoterboshr@sogou.com', 'dscoterboshr@sogou.com', 'Frilled dragon', 'Daniele', 'Scoterbosh', '06183 Bartillon Trail', '1985-02-15');
CALL RegisterBidder('gcheynes@wufoo.com', 'gcheynes@wufoo.com', 'Monkey, black spider', 'Giorgio', 'Cheyne', '292 Thompson Circle', '2011-06-29');
CALL RegisterBidder('amaccarrollt@seesaa.net', 'amaccarrollt@seesaa.net', 'Brown capuchin', 'Agnesse', 'MacCarroll', '988 Upham Alley', '1989-10-28');
CALL RegisterBidder('kcooneyu@quantcast.com', 'kcooneyu@quantcast.com', 'Pied avocet', 'Kirstyn', 'Cooney', '53 Dexter Parkway', '1985-12-29');
CALL RegisterBidder('crickhussv@flickr.com', 'crickhussv@flickr.com', 'Kelp gull', 'Carly', 'Rickhuss', '6711 Monica Park', '1999-09-17');
CALL RegisterBidder('bcastagnetox@squarespace.com', 'bcastagnetox@squarespace.com', 'Yellow-headed caracara', 'Bellina', 'Castagneto', '4 Comanche Park', '1997-02-18');
CALL RegisterBidder('bkassmany@csmonitor.com', 'bkassmany@csmonitor.com', 'Loris, slender', 'Bert', 'Kassman', '717 Meadow Vale Road', '1984-07-27');
CALL RegisterBidder('wbullcock10@whitehouse.gov', 'wbullcock10@whitehouse.gov', 'Capybara', 'Wakefield', 'Bullcock', '60 Division Parkway', '1991-03-10');
CALL RegisterBidder('fmullan11@de.vu', 'fmullan11@de.vu', 'Spotted hyena', 'Filberte', 'Mullan', '066 Merrick Avenue', '2002-12-08');
CALL RegisterBidder('egreystoke12@amazon.com', 'egreystoke12@amazon.com', 'Jackal, indian', 'Engracia', 'Greystoke', '4921 Mcguire Pass', '1984-12-08');
CALL RegisterBidder('pschaffel13@drupal.org', 'pschaffel13@drupal.org', 'Common wombat', 'Pam', 'Schaffel', '5897 Ludington Road', '2001-11-15');
CALL RegisterBidder('checkle15@umich.edu', 'checkle15@umich.edu', 'Badger, european', 'Corbie', 'Heckle', '179 South Circle', '1984-12-17');
CALL RegisterBidder('ldroogan16@springer.com', 'ldroogan16@springer.com', 'Elk, Wapiti', 'Lucian', 'Droogan', '479 Redwing Plaza', '1999-04-18');
CALL RegisterBidder('dbowcock17@imgur.com', 'dbowcock17@imgur.com', 'Snake (unidentified)', 'Darb', 'Bowcock', '057 Novick Junction', '2018-03-23');
CALL RegisterBidder('rboddam18@cbsnews.com', 'rboddam18@cbsnews.com', 'Two-toed tree sloth', 'Rene', 'Boddam', '68939 Ramsey Crossing', '1991-06-03');
CALL RegisterBidder('nbillingsly19@phoca.cz', 'nbillingsly19@phoca.cz', 'Fox, blue', 'Nonah', 'Billingsly', '408 Ilene Avenue', '1984-05-16');
CALL RegisterBidder('gwybern1a@spiegel.de', 'gwybern1a@spiegel.de', 'Black spider monkey', 'Gerty', 'Wybern', '74674 Packers Pass', '2006-08-30');
CALL RegisterBidder('mhasson1b@bluehost.com', 'mhasson1b@bluehost.com', 'Eastern box turtle', 'Malinde', 'Hasson', '94 Logan Pass', '2014-04-23');
CALL RegisterBidder('miacomettii1c@tuttocitta.it', 'miacomettii1c@tuttocitta.it', 'Blackbuck', 'Mayne', 'Iacomettii', '28598 Buhler Junction', '2014-07-08');
CALL RegisterBidder('fjaffa1d@mozilla.org', 'fjaffa1d@mozilla.org', 'Duiker, gray', 'Forest', 'Jaffa', '12 Hermina Trail', '1997-09-09');
CALL RegisterBidder('haucoate1f@is.gd', 'haucoate1f@is.gd', 'Red-legged pademelon', 'Hyacinthie', 'Aucoate', '9507 Meadow Ridge Way', '2017-08-08');
CALL RegisterBidder('pdosdell1m@cargocollective.com', 'pdosdell1m@cargocollective.com', 'Black-footed ferret', 'Prinz', 'Dosdell', '95035 Hoffman Court', '1992-05-29');
CALL RegisterBidder('primer1n@google.es', 'primer1n@google.es', 'Goose, egyptian', 'Pinchas', 'Rimer', '2274 Doe Crossing Junction', '1980-04-12');
CALL RegisterBidder('cmarkova1o@moonfruit.com', 'cmarkova1o@moonfruit.com', 'Ground monitor (unidentified)', 'Conrad', 'Markova', '865 Sullivan Crossing', '1984-05-08');
CALL RegisterBidder('wcashford1p@cpanel.net', 'wcashford1p@cpanel.net', 'Indian red admiral', 'Westbrooke', 'Cashford', '0 Hintze Court', '1986-06-08');
CALL RegisterBidder('scaunt1q@omniture.com', 'scaunt1q@omniture.com', 'Steenbok', 'Shepperd', 'Caunt', '45 Shelley Park', '1986-11-11');
CALL RegisterBidder('arayman1r@boston.com', 'arayman1r@boston.com', 'Hoary marmot', 'Alli', 'Rayman', '268 Ronald Regan Crossing', '1992-12-06');
CALL RegisterBidder('rstears1s@apple.com', 'rstears1s@apple.com', 'Blacksmith plover', 'Rabi', 'Stears', '381 Kipling Trail', '1983-02-02');
CALL RegisterBidder('awellstood1t@w3.org', 'awellstood1t@w3.org', 'Bird, bare-faced go away', 'Agata', 'Wellstood', '038 Kedzie Place', '2012-06-18');
CALL RegisterBidder('qburbudge1u@wisc.edu', 'qburbudge1u@wisc.edu', 'Hyrax', 'Queenie', 'Burbudge', '034 Banding Place', '1998-09-22');
CALL RegisterBidder('mbladon1v@clickbank.net', 'mbladon1v@clickbank.net', 'African darter', 'Molli', 'Bladon', '1263 Burning Wood Pass', '1990-11-05');
CALL RegisterBidder('fprine1w@meetup.com', 'fprine1w@meetup.com', 'Pelican, eastern white', 'Fons', 'Prine', '466 Toban Center', '1980-08-18');
CALL RegisterBidder('arailton1x@google.it', 'arailton1x@google.it', 'Little cormorant', 'Austina', 'Railton', '990 Morning Alley', '2003-04-13');
CALL RegisterBidder('ctuting1y@utexas.edu', 'ctuting1y@utexas.edu', 'Sheep, red', 'Cinderella', 'Tuting', '7835 Prentice Alley', '1996-04-12');
CALL RegisterBidder('apicot1z@epa.gov', 'apicot1z@epa.gov', 'Phalarope, red', 'Alan', 'Picot', '79767 Clemons Hill', '1990-02-06');
CALL RegisterBidder('dwesson20@slashdot.org', 'dwesson20@slashdot.org', 'Eleven-banded armadillo (unidentified)', 'Dianne', 'Wesson', '60833 Maple Trail', '1986-06-21');
CALL RegisterBidder('bcornu21@addthis.com', 'bcornu21@addthis.com', 'Pie, rufous tree', 'Bliss', 'Cornu', '80 Rieder Plaza', '2019-06-05');
CALL RegisterBidder('abook22@dyndns.org', 'abook22@dyndns.org', 'Possum, pygmy', 'Amandie', 'Book', '96691 Laurel Street', '1987-07-24');
CALL RegisterBidder('vpenna23@hexun.com', 'vpenna23@hexun.com', 'Common eland', 'Vale', 'Penna', '639 Bowman Court', '2018-11-02');
CALL RegisterBidder('dpitkin24@gov.uk', 'dpitkin24@gov.uk', 'Creeper, black-tailed tree', 'Dixie', 'Pitkin', '67 Forest Run Circle', '1985-02-22');
CALL RegisterBidder('lfussen25@reference.com', 'lfussen25@reference.com', 'Bird, magnificent frigate', 'Lyon', 'Fussen', '131 Sycamore Park', '1980-04-11');
CALL RegisterBidder('mslimmon26@deliciousdays.com', 'mslimmon26@deliciousdays.com', 'Kafue flats lechwe', 'Maryann', 'Slimmon', '5 Manley Alley', '1998-09-20');
CALL RegisterBidder('rspiniello27@si.edu', 'rspiniello27@si.edu', 'Chacma baboon', 'Rozanne', 'Spiniello', '34441 Red Cloud Plaza', '2006-06-04');
CALL RegisterBidder('oreisen28@purevolume.com', 'oreisen28@purevolume.com', 'Roseat flamingo', 'Owen', 'Reisen', '12853 Shoshone Plaza', '2018-04-11');
CALL RegisterBidder('fkimmel29@geocities.com', 'fkimmel29@geocities.com', 'Raven, white-necked', 'Francoise', 'Kimmel', '02351 Brown Alley', '1996-04-12');
CALL RegisterBidder('dciccarelli2a@addtoany.com', 'dciccarelli2a@addtoany.com', 'Raven, white-necked', 'Dotti', 'Ciccarelli', '36516 Knutson Point', '2017-03-06');
CALL RegisterBidder('rbroker2b@theguardian.com', 'rbroker2b@theguardian.com', 'Slender loris', 'Rhonda', 'Broker', '40 Derek Avenue', '1980-04-12');
CALL RegisterBidder('fleece2c@twitpic.com', 'fleece2c@twitpic.com', 'Crake, african black', 'Faythe', 'Leece', '85 Monument Park', '2016-02-04');
CALL RegisterBidder('swhittleton2d@hc360.com', 'swhittleton2d@hc360.com', 'Eurasian red squirrel', 'Stefanie', 'Whittleton', '57152 Lindbergh Junction', '1993-03-09');
CALL RegisterBidder('sgave2e@imdb.com', 'sgave2e@imdb.com', 'Lion, mountain', 'Shermie', 'Gave', '13 Warrior Place', '1991-07-22');
CALL RegisterBidder('mlauxmann2f@parallels.com', 'mlauxmann2f@parallels.com', 'Porcupine, prehensile-tailed', 'Miquela', 'Lauxmann', '5854 Bunting Drive', '2004-12-08');
CALL RegisterBidder('gsterricker2g@mit.edu', 'gsterricker2g@mit.edu', 'Weaver, sociable', 'Genovera', 'Sterricker', '7 Morrow Avenue', '1996-11-17');
CALL RegisterBidder('mpavlasek2h@phoca.cz', 'mpavlasek2h@phoca.cz', 'Tarantula, salmon pink bird eater', 'Meyer', 'Pavlasek', '9 Dixon Alley', '2019-07-05');
CALL RegisterBidder('nmaryan2i@arizona.edu', 'nmaryan2i@arizona.edu', 'Drongo, fork-tailed', 'Nomi', 'Maryan', '97288 Claremont Crossing', '2008-05-05');
CALL RegisterBidder('apickford2j@gnu.org', 'apickford2j@gnu.org', 'Dragon, netted rock', 'Alleyn', 'Pickford', '67394 Sycamore Way', '2005-02-18');
CALL RegisterBidder('oohrtmann2k@last.fm', 'oohrtmann2k@last.fm', 'Brown brocket', 'Ogdon', 'Ohrtmann', '8 Nova Pass', '2004-02-02');
-- SELECT * FROM `User`;
-- SELECT * FROM `Bidder`;
