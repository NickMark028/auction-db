...
/* USER + BIDDER */
/*********************************************************/
CALL RegisterBidder ('estrephan0', 'estrephan0@tiny.cc', '0BrEhhDcsG', 'Efren', 'Strephan', '39 Buhler Circle', '2021-04-15');
CALL RegisterBidder ('bcoronado1', 'bcoronado1@sciencedaily.com', 'm04E1lC', 'Beniamino', 'Coronado', '928 Beilfuss Street', '2021-11-05');
CALL RegisterBidder ('edrogan2', 'edrogan2@google.es', 'gDjn3W0TPbK', 'Elnar', 'Drogan', '6 Talisman Alley', '2021-07-27');
CALL RegisterBidder ('tgoding3', 'tgoding3@chicagotribune.com', 'mOiJgpkzo', 'Thorstein', 'Goding', '751 Northwestern Alley', '2021-06-16');
CALL RegisterBidder ('kknipe4', 'kknipe4@scribd.com', 'UpMt604gj1', 'Keith', 'Knipe', '36 Bay Street', '2021-04-25');
CALL RegisterBidder ('mcapineer5', 'mcapineer5@msn.com', '1rmPpTXR', 'Marshal', 'Capineer', '6 Raven Trail', '2021-03-19');
CALL RegisterBidder ('tblow6', 'tblow6@people.com.cn', 'yWwdY3Dg', 'Truman', 'Blow', '21971 Center Trail', '2021-12-31');
CALL RegisterBidder ('credhouse7', 'credhouse7@com.com', '8uWP5q', 'Clint', 'Redhouse', '0 Bobwhite Street', '2021-11-03');
CALL RegisterBidder ('ahazeltine8', 'ahazeltine8@google.co.uk', '9kybKo188Yh2', 'Antony', 'Hazeltine', '938 Old Shore Park', '2021-08-04');
CALL RegisterBidder ('sfeitosa9', 'sfeitosa9@cargocollective.com', 'j95GRJGctIHE', 'Smith', 'Feitosa', '9739 Elmside Point', '2021-08-30');
CALL RegisterBidder ('cbernholta', 'cbernholta@bloomberg.com', 'F81NqRrDzM', 'Curran', 'Bernholt', '3 Northview Avenue', '2021-03-18');
CALL RegisterBidder ('bcalderab', 'bcalderab@ed.gov', 'HxN2VgOYRuf', 'Bertie', 'Caldera', '980 Hallows Terrace', '2021-06-11');
CALL RegisterBidder ('heriec', 'heriec@vinaora.com', 'p1QxeG', 'Hervey', 'Erie', '97859 Hanover Park', '2021-02-24');
CALL RegisterBidder ('flepiscopiod', 'flepiscopiod@goo.ne.jp', 'XzszRy', 'Francklyn', 'L''Episcopio', '1828 Starling Alley', '2021-06-27');
CALL RegisterBidder ('mdarnodye', 'mdarnodye@webeden.co.uk', 'gZZRK2RjYbq3', 'Myrwyn', 'Darnody', '6 Di Loreto Junction', '2021-12-28');
CALL RegisterBidder ('hastupenasf', 'hastupenasf@csmonitor.com', 'bTb9T2Dvcu', 'Hadlee', 'Astupenas', '2180 Vera Alley', '2021-12-10');
CALL RegisterBidder ('wfawlog', 'wfawlog@digg.com', 'OBEd3GvRd', 'Way', 'Fawlo', '08 Buena Vista Center', '2021-07-09');
CALL RegisterBidder ('cstranierih', 'cstranierih@guardian.co.uk', 's70yncx', 'Curtice', 'Stranieri', '26807 Buena Vista Avenue', '2021-05-28');
CALL RegisterBidder ('kpapierzi', 'kpapierzi@com.com', '7jBtqCiIbJ07', 'Keenan', 'Papierz', '9687 Stone Corner Place', '2021-05-24');
CALL RegisterBidder ('ktrowerj', 'ktrowerj@senate.gov', 'cW0bWvCeyE2', 'Koenraad', 'Trower', '503 Mariners Cove Point', '2021-11-09');
CALL RegisterBidder ('rmacknockiterk', 'rmacknockiterk@yahoo.co.jp', 'DczTA97Hg', 'Rawley', 'MacKnockiter', '3 American Ash Court', '2021-05-29');
CALL RegisterBidder ('esteanel', 'esteanel@sfgate.com', 'g8OuwM', 'Emery', 'Steane', '93 Merrick Place', '2021-03-08');
CALL RegisterBidder ('odaytonm', 'odaytonm@biblegateway.com', 'IXsUBMXYU6', 'Odo', 'Dayton', '306 Dapin Lane', '2021-03-09');
CALL RegisterBidder ('bbreslaun', 'bbreslaun@accuweather.com', 'J7dTMo', 'Bartlett', 'Breslau', '00 Forest Street', '2021-09-12');
CALL RegisterBidder ('wsawleo', 'wsawleo@topsy.com', 'DKud0Kon', 'Wye', 'Sawle', '212 Oriole Road', '2021-10-15');
CALL RegisterBidder ('hscoldingp', 'hscoldingp@bloglines.com', 'Ux4eTWge', 'Harvey', 'Scolding', '14975 Elka Road', '2021-07-22');
CALL RegisterBidder ('blordenq', 'blordenq@usnews.com', 'PCkGLt', 'Brendon', 'Lorden', '0 Harper Terrace', '2021-09-27');
CALL RegisterBidder ('cfrowenr', 'cfrowenr@unblog.fr', 'RVZCID1MeoW', 'Cobby', 'Frowen', '207 Sloan Drive', '2021-07-04');
CALL RegisterBidder ('adafferns', 'adafferns@example.com', '2DuSAhB', 'Allie', 'Daffern', '719 Shopko Plaza', '2021-09-10');
CALL RegisterBidder ('osealeyt', 'osealeyt@gov.uk', 'vJr6uxkZmb', 'Oswald', 'Sealey', '2 Moland Pass', '2021-02-01');
CALL RegisterBidder ('vcrosonu', 'vcrosonu@hhs.gov', 'uESR0GJ', 'Vince', 'Croson', '6 Spenser Drive', '2021-05-21');
CALL RegisterBidder ('gcrabtreev', 'gcrabtreev@reuters.com', 'tplcw0HBg', 'Garreth', 'Crabtree', '14888 Thierer Avenue', '2021-03-25');
CALL RegisterBidder ('lrupertow', 'lrupertow@constantcontact.com', 'RZBlDS8Ama3', 'Lane', 'Ruperto', '0 Toban Street', '2021-10-29');
CALL RegisterBidder ('bjohnx', 'bjohnx@google.fr', 'OUffWd9b', 'Bary', 'John', '8 Russell Court', '2021-07-25');
CALL RegisterBidder ('dluxfordy', 'dluxfordy@furl.net', 'XoPbXTJh', 'Darb', 'Luxford', '7 Bluejay Lane', '2021-07-20');
CALL RegisterBidder ('vplatfootz', 'vplatfootz@tinyurl.com', 'gU4KJGs346', 'Victoir', 'Platfoot', '91687 Charing Cross Avenue', '2021-11-29');
CALL RegisterBidder ('ditzcak10', 'ditzcak10@sakura.ne.jp', 'B7f3pXVrVPm', 'Darrin', 'Itzcak', '6743 Mariners Cove Drive', '2021-09-24');
CALL RegisterBidder ('letock11', 'letock11@rakuten.co.jp', 'Lfe07kkKcSm', 'Lane', 'Etock', '65826 Shopko Alley', '2021-10-31');
CALL RegisterBidder ('gcurteis12', 'gcurteis12@pagesperso-orange.fr', 'qLz9AhNE', 'Garrek', 'Curteis', '3257 Forest Place', '2021-10-07');
CALL RegisterBidder ('rresun13', 'rresun13@paypal.com', 'VdByRc4', 'Reade', 'Resun', '48 John Wall Street', '2021-07-20');
CALL RegisterBidder ('dduckhouse14', 'dduckhouse14@dion.ne.jp', 'SE8NzN8Htn1', 'Davidson', 'Duckhouse', '2072 Pierstorff Way', '2021-11-30');
CALL RegisterBidder ('gfernandez15', 'gfernandez15@dropbox.com', 'ecd1KVeom', 'Gunter', 'Fernandez', '1 Muir Center', '2021-11-07');
CALL RegisterBidder ('pmaypowder16', 'pmaypowder16@mtv.com', 'iXqTVtmih', 'Porty', 'Maypowder', '0 Moland Park', '2021-03-13');
CALL RegisterBidder ('elippingwell17', 'elippingwell17@freewebs.com', 'XNJQOzBdZoK', 'Evelyn', 'Lippingwell', '2511 Columbus Hill', '2021-04-23');
CALL RegisterBidder ('nstollenbecker18', 'nstollenbecker18@webeden.co.uk', 'a33hwAYFBT1X', 'Nevins', 'Stollenbecker', '47071 Warrior Plaza', '2021-08-13');
CALL RegisterBidder ('drotham19', 'drotham19@msn.com', 'W9Ssfd', 'Darrin', 'Rotham', '36 Tomscot Parkway', '2021-02-28');
CALL RegisterBidder ('nyakunkin1a', 'nyakunkin1a@earthlink.net', 'upA2aa5ao5OL', 'Nicol', 'Yakunkin', '68 American Ash Way', '2021-07-06');
CALL RegisterBidder ('vhallbird1b', 'vhallbird1b@naver.com', 'LvSODXtLX', 'Verney', 'Hallbird', '0684 New Castle Lane', '2021-10-26');
CALL RegisterBidder ('hsollom1c', 'hsollom1c@dedecms.com', 'uxAfMHb2d', 'Haley', 'Sollom', '30938 Mallory Drive', '2021-12-09');
CALL RegisterBidder ('nvodden1d', 'nvodden1d@nifty.com', 'Tbj8W33', 'Norby', 'Vodden', '38368 Delladonna Place', '2021-12-11');
CALL RegisterBidder ('adinneen1e', 'adinneen1e@google.es', 'EErO7GGq', 'Alwin', 'Dinneen', '0 Cambridge Crossing', '2021-02-07');
CALL RegisterBidder ('schasmoor1f', 'schasmoor1f@1688.com', 'snC314E12MRR', 'Shay', 'Chasmoor', '19 John Wall Court', '2021-09-21');
CALL RegisterBidder ('pyakubovich1g', 'pyakubovich1g@qq.com', 'Q7frnBUp', 'Pren', 'Yakubovich', '93284 Farragut Court', '2021-05-07');
CALL RegisterBidder ('vbraddock1h', 'vbraddock1h@constantcontact.com', 'SZllsiisXst9', 'Vick', 'Braddock', '249 Stephen Circle', '2021-11-13');
CALL RegisterBidder ('fwinton1i', 'fwinton1i@ucla.edu', 'UoJpCBcp71i', 'Finn', 'Winton', '0 Upham Trail', '2021-09-03');
CALL RegisterBidder ('ckurth1j', 'ckurth1j@springer.com', 'O5eXKP', 'Cyrill', 'Kurth', '51870 Duke Trail', '2021-04-05');
CALL RegisterBidder ('lalessandretti1k', 'lalessandretti1k@barnesandnoble.com', 'VXbkVDKU', 'Lucas', 'Alessandretti', '6187 Ramsey Pass', '2021-04-24');
CALL RegisterBidder ('djanu1l', 'djanu1l@rakuten.co.jp', '87Va39z6f7L', 'Dill', 'Janu', '66842 Hanson Way', '2021-09-08');
CALL RegisterBidder ('mscarasbrick1m', 'mscarasbrick1m@weibo.com', 'oP70dvb37eUK', 'Morris', 'Scarasbrick', '19 Express Junction', '2021-05-12');
CALL RegisterBidder ('jtoovey1n', 'jtoovey1n@twitter.com', 'C28cTati36', 'Janek', 'Toovey', '155 Schmedeman Plaza', '2021-11-05');
CALL RegisterBidder ('dcobbin1o', 'dcobbin1o@privacy.gov.au', 'togmWWa', 'Daryle', 'Cobbin', '1771 Butternut Junction', '2021-04-22');
CALL RegisterBidder ('fangerstein1p', 'fangerstein1p@newyorker.com', '53B3QX', 'Felipe', 'Angerstein', '36424 Grover Place', '2021-06-06');
CALL RegisterBidder ('jmalarkey1q', 'jmalarkey1q@123-reg.co.uk', '7bX7kukMJ0', 'Josiah', 'Malarkey', '888 Jackson Road', '2021-07-14');
CALL RegisterBidder ('jstoodale1r', 'jstoodale1r@oaic.gov.au', '7BDAlj18ykq', 'Job', 'Stoodale', '2 Morning Trail', '2021-12-29');
CALL RegisterBidder ('mkupper1s', 'mkupper1s@virginia.edu', '7vuMwrek', 'Maxie', 'Kupper', '9839 Jenna Hill', '2021-05-24');
CALL RegisterBidder ('jburtwell1t', 'jburtwell1t@surveymonkey.com', 'dkEe4sf2', 'Jose', 'Burtwell', '317 Fairview Junction', '2021-08-22');
CALL RegisterBidder ('bpavia1u', 'bpavia1u@51.la', '2K9KPc4', 'Bennie', 'Pavia', '14 Fieldstone Terrace', '2021-07-04');
CALL RegisterBidder ('gstiffkins1v', 'gstiffkins1v@t-online.de', 'AdGhmyrf', 'Gregg', 'Stiffkins', '5 Veith Plaza', '2021-09-08');
CALL RegisterBidder ('beves1w', 'beves1w@topsy.com', 'ckZ4MBs09', 'Benson', 'Eves', '568 Mcguire Street', '2021-12-02');
CALL RegisterBidder ('galdis1x', 'galdis1x@people.com.cn', 'IInl0L2aaZpf', 'Gardener', 'Aldis', '52640 Main Terrace', '2021-03-08');
CALL RegisterBidder ('kmccaskell1y', 'kmccaskell1y@mysql.com', 'R830VG1', 'Keven', 'McCaskell', '2353 Buell Park', '2021-02-19');
CALL RegisterBidder ('htollmache1z', 'htollmache1z@howstuffworks.com', '3icVxk', 'Huey', 'Tollmache', '9 Tomscot Terrace', '2021-07-13');
CALL RegisterBidder ('blinguard20', 'blinguard20@t.co', 'qNwYkAMq', 'Bourke', 'Linguard', '394 Corscot Hill', '2021-11-22');
CALL RegisterBidder ('fhawtry21', 'fhawtry21@loc.gov', '5kyA5xk', 'Flinn', 'Hawtry', '151 Dennis Place', '2021-03-15');
CALL RegisterBidder ('jleaf22', 'jleaf22@wikimedia.org', '05ymkR', 'Jeffie', 'Leaf', '83366 Sunbrook Avenue', '2021-03-26');
CALL RegisterBidder ('ctomblings23', 'ctomblings23@xrea.com', 'U04aZOCtvDWG', 'Charles', 'Tomblings', '119 Melody Pass', '2021-10-03');
CALL RegisterBidder ('njouannot24', 'njouannot24@gov.uk', '7zXml78hYif', 'Nichole', 'Jouannot', '5 Meadow Valley Trail', '2021-07-08');
CALL RegisterBidder ('eramey25', 'eramey25@tmall.com', '29pNG8X', 'Emmet', 'Ramey', '3893 Northland Drive', '2021-08-27');
CALL RegisterBidder ('rpammenter26', 'rpammenter26@quantcast.com', 'IvEnF8', 'Riley', 'Pammenter', '02 Hovde Trail', '2021-03-16');
CALL RegisterBidder ('lferriby27', 'lferriby27@twitpic.com', 'MCNT9Up4', 'Ludvig', 'Ferriby', '235 Summer Ridge Alley', '2021-02-03');
CALL RegisterBidder ('jbirchill28', 'jbirchill28@friendfeed.com', 'U4S8TOB', 'Jan', 'Birchill', '4 International Terrace', '2021-10-30');
CALL RegisterBidder ('ucecely29', 'ucecely29@slate.com', '2ZPSDJD3dp', 'Udall', 'Cecely', '8 Summerview Alley', '2021-10-06');
CALL RegisterBidder ('fslaney2a', 'fslaney2a@nyu.edu', 'C9TKy8', 'Filmer', 'Slaney', '6601 7th Plaza', '2021-07-27');
CALL RegisterBidder ('mwitt2b', 'mwitt2b@icio.us', 'TmZNx1', 'Myrwyn', 'Witt', '9 Meadow Vale Way', '2021-02-11');
CALL RegisterBidder ('vhallgalley2c', 'vhallgalley2c@people.com.cn', 'Cde2ObFl', 'Vergil', 'Hallgalley', '419 Surrey Lane', '2021-04-19');
CALL RegisterBidder ('cnegro2d', 'cnegro2d@discovery.com', 'nRtpiudfW86', 'Chas', 'Negro', '18910 Schmedeman Terrace', '2021-07-09');
CALL RegisterBidder ('wvanyakin2e', 'wvanyakin2e@bbc.co.uk', 'rc5qfc1fUt', 'Welbie', 'Vanyakin', '3001 Mitchell Plaza', '2021-04-24');
CALL RegisterBidder ('coldred2f', 'coldred2f@earthlink.net', 'a9iu7baXgf', 'Carce', 'Oldred', '94 Boyd Court', '2021-03-02');
CALL RegisterBidder ('ggianettini2g', 'ggianettini2g@soup.io', 'XIUSJ1Dx2', 'Granville', 'Gianettini', '833 Melrose Alley', '2021-04-05');
CALL RegisterBidder ('lshambroke2h', 'lshambroke2h@yahoo.co.jp', 'rZji3Udosxor', 'Lamar', 'Shambroke', '15 Lakeland Lane', '2021-08-16');
CALL RegisterBidder ('ischistl2i', 'ischistl2i@newyorker.com', 'CQFhpf', 'Inglebert', 'Schistl', '3449 Debra Way', '2021-07-11');
CALL RegisterBidder ('asamett2j', 'asamett2j@oaic.gov.au', 'WdfgTB', 'Ambrosi', 'Samett', '96230 Moose Lane', '2021-06-21');
CALL RegisterBidder ('swardlaw2k', 'swardlaw2k@liveinternet.ru', 'Moc0DvqD', 'Spense', 'Wardlaw', '1 Hintze Road', '2021-11-26');
CALL RegisterBidder ('dcowgill2l', 'dcowgill2l@who.int', 'UtyIbWo2Rr', 'Denys', 'Cowgill', '68 Dennis Crossing', '2021-02-20');
CALL RegisterBidder ('tzuann2m', 'tzuann2m@nyu.edu', 'dIi2ZmGP', 'Tyson', 'Zuann', '7961 Eastlawn Center', '2021-07-30');
CALL RegisterBidder ('wkobierra2n', 'wkobierra2n@miibeian.gov.cn', 'ZoAbOwIxNr', 'Whittaker', 'Kobierra', '2778 Becker Court', '2021-12-21');
CALL RegisterBidder ('lsellan2o', 'lsellan2o@yandex.ru', 'bh9f8ciePA', 'Lodovico', 'Sellan', '3 Westport Pass', '2021-12-24');
CALL RegisterBidder ('eplacstone2p', 'eplacstone2p@noaa.gov', 'd4QCjNgU', 'Edward', 'Placstone', '4 Macpherson Place', '2021-07-09');
CALL RegisterBidder ('rspada2q', 'rspada2q@typepad.com', 'AhLtTC', 'Reinwald', 'Spada', '094 Havey Hill', '2021-12-05');
CALL RegisterBidder ('lohaire2r', 'lohaire2r@wikimedia.org', 'bYfJim', 'Leopold', 'O''Haire', '3196 Packers Terrace', '2021-11-22');
